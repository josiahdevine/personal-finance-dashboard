...
export function adaptBalanceHistoryResponse(data) {
  ...
  console.warn('Unexpected balance history data format:', data);
  return {
    labels: [],
    datasets: [{
      label: 'Net Worth',
...
export function adaptMonthlySalaryResponse(data) {
  ...
  // Default fallback
  console.warn('Unexpected monthly income data format:', data);
  return { average: 0 };
}
...
export function adaptSpendingSummaryResponse(data) {
  ...
  // Default fallback
  console.warn('Unexpected spending summary data format:', data);
  return {
    total: 0,
    categories: []
  };
...
export function adaptGoalsResponse(data) {
  ...
  // Default fallback
  console.warn('Unexpected goals data format:', data);
  return [];
} 