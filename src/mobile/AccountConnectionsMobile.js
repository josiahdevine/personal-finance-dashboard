...
import { HiOutlineRefresh, HiOutlineCreditCard, HiOutlinePlusCircle } from 'react-icons/hi';
    ...
    <div className="px-4 py-6">
      ...
      {plaidAccounts.length === 0 ? (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 text-center">
          ...
          >
            {loading || plaidLoading ? 'Connecting...' : 'Connect Bank'}
          </button>
        </div>
      ) : (
          ...
          {plaidAccounts.map((account) => (
            <div key={account.id || account.account_id} className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
              <button
                ...
                className="w-full p-4 flex items-center justify-between cursor-pointer hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
              >
