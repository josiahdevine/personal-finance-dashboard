          ...
          {subscription.cancelAtPeriodEnd ? (
            <div className="bg-yellow-50 p-3 rounded border border-yellow-200 text-sm">
              ...
              <button 
                ...
                className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
              >
                Contact us
              </button>
            </div>
            ...
            <div className="flex justify-center mt-4">
              <button
                ...
                className="text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
              >
                Cancel Subscription
              </button>
            </div>
            ...
            {plansToDisplay.map((plan) => (
              ...
              >
                ...
                <button
                  ...
                  className="w-full px-6 py-3 text-base font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 rounded-md shadow-sm"
                >
                  {subscription && subscription.active && subscription.cancelAtPeriodEnd
                    ? 'Reactivate'
                    : 'Select Plan'}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl p-6 w-full max-h-[90vh] overflow-y-auto">
            ...
            {paymentMethods.length > 0 && (
              <div className="mb-5">
                <label className="block text-gray-700 text-sm mb-2" htmlFor="Payment Method">Payment Method</label>
                <select
            ...
            {(showNewCardForm || paymentMethods.length === 0) && (
              <form onSubmit={handleSubscribeWithNewCard}>
                <div className="mb-5">
                  <label className="block text-gray-700 text-sm mb-2" htmlFor="Card Details">Card Details</label>
