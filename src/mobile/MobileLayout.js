    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-30 transition-all duration-300">
        <div className="flex justify-between items-center p-4">
          <Button
            variant="outline"
            onClick={toggleMenu}
            className="p-2 rounded-md text-gray-700 hover:bg-gray-100 active:scale-95 transition-transform duration-150"
            ariaLabel="Open menu"
          >
            {isMenuOpen ? (
          ...
          <div className="flex items-center space-x-2">
            <Button
              ...
              className="relative p-2 rounded-md text-gray-700 hover:bg-gray-100 active:scale-95 transition-transform duration-150"
        ...
        <div className="absolute inset-y-0 left-0 max-w-xs w-full bg-white shadow-xl flex flex-col transform transition-transform duration-500">
          <div className="flex items-center justify-between px-4 py-6 border-b border-gray-200">
            ...
            <Button
              variant="outline"
              onClick={toggleMenu}
              className="rounded-md text-gray-500 hover:text-gray-700 active:scale-95 transition-transform duration-150"
      ...
      <div className="fixed bottom-4 right-4 z-30">
        <Button
          ...
          className="p-4 rounded-full shadow-lg transition-transform duration-200 active:scale-95"
