...
class ErrorBoundary extends React.Component {
  constructor(props) {
    ...
    console.log(`[ErrorBoundary] Created for component: ${props.componentName || 'Unknown'}`);
  }
  ...
  resetError = () => {
    console.log(`[ErrorBoundary] Resetting error state for: ${this.props.componentName || 'Unknown'}`);
