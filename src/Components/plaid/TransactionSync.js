          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                className="flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 rounded-md"
              >
                <HiOutlineRefresh className={`h-5 w-5 mr-2 ${syncStatus === 'syncing' ? 'animate-spin' : ''}`} />
                Sync Transactions
              </button>
            </div>
