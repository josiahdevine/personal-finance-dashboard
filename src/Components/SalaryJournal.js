        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
            ...
            <div className="mt-4 flex justify-end space-x-3">
                ...
                <Button
                    ...
                    disabled={!rsuForm.sharesGranted || !rsuForm.fairMarketValue || !rsuForm.vestingType || !rsuForm.vestingSchedule || !rsuForm.vestingPeriodYears || !rsuForm.cliffPeriodMonths}
                >
                    Save RSU Grant
                </Button>
            </div>
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex items-center space-x-2 mb-6">
                <label className="font-medium" htmlFor="User:">User:</label>
                <select
