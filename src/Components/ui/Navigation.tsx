      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="flex-shrink-0 flex items-center">
            <span className="text-xl font-bold text-indigo-600">FinDash</span>
          </div>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              {/* Mobile Integrate Button */}
              <button
                onClick={() => {
                  onTabChange('integrate');
                  setIsMobileMenuOpen(false);
                }}
                className="w-full flex items-center px-3 py-2 rounded-md text-base font-medium bg-indigo-600 text-white hover:bg-indigo-700"
              >
                <svg
