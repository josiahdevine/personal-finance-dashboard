...
import { HomeIcon, CreditCardIcon, CurrencyDollarIcon, ReceiptRefundIcon, FlagIcon, ChartBarIcon, ClockIcon, ArrowTrendingUpIcon, LinkIcon, ChatBubbleLeftRightIcon } from '@heroicons/react/24/outline';
...
const navigationItems = [
  ...
  { name: 'Salary', href: '/dashboard/salary', icon: CurrencyDollarIcon },
  ...
  { name: 'Plaid', href: '/dashboard/plaid', icon: LinkIcon },
