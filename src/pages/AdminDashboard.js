        ...
        <div className="bg-white shadow rounded-lg p-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <button 
              ...
              onClick={() => navigate('/admin/users')} onKeyDown={() => navigate('/admin/users')} role="button" tabIndex={0}
            >
              Manage Users
            </button>
            <button 
              className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition-colors"
              onClick={() => navigate('/admin/database')} onKeyDown={() => navigate('/admin/database')} role="button" tabIndex={0}
            >
              Database Management
            </button>
            <button 
              className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition-colors"
              onClick={() => navigate('/admin/settings')} onKeyDown={() => navigate('/admin/settings')} role="button" tabIndex={0}
            >
              System Settings
            </button>
          </div>
